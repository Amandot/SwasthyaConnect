...
import { LogIn, ArrowRight, Lock, Mail, User as UserIcon, Eye, EyeOff, ArrowLeft } from 'lucide-react';
      ...
      <Card className="max-w-md w-full p-8 relative z-10 shadow-premium border-slate-200/60 bg-white">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-extrabold text-slate-900 tracking-tight">
            {t('auth.signup.patient.title', 'Create Patient Account')}
          </h2>
          <p className="mt-2 text-sm text-slate-600 font-medium">
            {t('auth.signup.patient.subtitle', 'Sign up to securely manage your appointments and health records.')}
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            >
              {!loading && (
                <>
                  {t('auth.createAccount', 'Create account')} <ArrowRight className="ml-2 h-4 w-4" />
                </>
              )}
            </Button>
          </form>
